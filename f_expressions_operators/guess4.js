...
const feedbackWrong = "Answer is wrong.";          // display when answer is wrong
const feedbackTooHigh = "Lower number please. Try again."; // display the number is too high
...
// as long as the user doesn't anter 'q' and 'Q', run the loop
while (userInput !== 'q') {

    let correctAns = false;               // flag (instantiated as)
    let feedback = "";                    // message placeholder
    ...
    alert(feedback);        // give the user the need feedback first
