...
const e2 = array2D[0][1]; /* index row 1, index col 1: Ans: 2 */  
const e3 = array2D[0][2]; /* index row 0, index col 2: Ans: 7 */ 

console.log(e1, e2, e3);

// Printing all the columns in the second row
const e4 = array2D[1][0]; /* index row 0, index col 0: Ans: 2 */   
const e5 = array2D[1][1]; /* index row 1, index col 1: Ans: 9 */  
const e6 = array2D[1][2]; /* index row 0, index col 2: Ans: 5 */ 

console.log(e4, e5, e6);

const e7 = array2D[2][0]; /* index row 0, index col 0: Ans: 5 */   
const e8 = array2D[2][1]; /* index row 1, index col 1: Ans: 1 */  
const e9 = array2D[2][2]; /* index row 0, index col 2: Ans: 5 */ 
