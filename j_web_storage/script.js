...
async function fetchColorsList() {
    ...
    try {
        ...
        let page = resp.page + 1;               // move pointer to page
        ...
        for (let currentPage = page; currentPage <= totalPages; currentPage++) {
            ...
            allColors.push(...resp.data);       // alternative: allColors = [...allColors, ...resp.data];      
        ...
        errHeader.className = "d-flex justify-content text-danger py-2";
